...
```{r bioscope_plot, fig.cap="Bioenergetic scope with replicates combined"}
...
```{r bioscope_plot_lme, fig.cap="Bioenergetic scope based on a mixed-effects model with replicates as random effect", message = FALSE}
bioscope_plot(energetics, sep_reps = FALSE, model = "mixed")
```

#### Replicates separated

```{r bioscope_plot_sep_reps, fig.cap="Bioenergetic scope with replicates separated"}
...
```{r ocr, fig.cap="OCR with replicates combined"}
ocr <- rate_plot(
  seahorse_rates,
  measure = "OCR",
  assay = "MITO",
...
```{r ocr_lme, fig.cap="OCR based on mixed-effects model"}
rate_plot(
  seahorse_rates,
  measure = "OCR",
  assay = "MITO",
...
```{r ocr_sep_reps, fig.cap="OCR with replicates separated"}
rate_plot(
  seahorse_rates,
  measure = "OCR",
  assay = "MITO",
...
```{r ecar, fig.cap="ECAR with replicates combined"}
ecar <- rate_plot(
  seahorse_rates,
  measure = "ECAR",
  assay = "GLYCO",
...
```{r ecar_lme, fig.cap="ECAR based on mixed-effects model"}
rate_plot(
  seahorse_rates,
  measure = "ECAR",
  assay = "GLYCO",
...
```{r ecar_sep, fig.cap="ECAR with replicates separated"}
rate_plot(
  seahorse_rates,
  measure = "ECAR",
  assay = "GLYCO",
...
```{r basal_glyc, fig.cap="JATP from basal glycolysis with replicates combined"}
basal_glyc <- atp_plot(
  energetics,
  basal_vs_max = "basal",
  glyc_vs_resp = "glyc",
...
```{r basal_resp, fig.cap="JATP from basal respiration with replicates separated"}
atp_plot(
  energetics,
  basal_vs_max = "basal",
  glyc_vs_resp = "resp",
...
```{r max_glyc, fig.cap="JATP from maximal glycolysis with a mixed-effects model"}
atp_plot(
  energetics,
  basal_vs_max = "max",
  glyc_vs_resp = "glyc",
...
```{r max_resp, fig.cap="JATP from maximal respiration replicates combined"}
atp_plot(
  energetics,
  basal_vs_max = "max",
  glyc_vs_resp = "resp",
